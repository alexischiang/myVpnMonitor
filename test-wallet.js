...
async function main() {
  ...
  try {
    ...
    assert.deepStrictEqual(hold, { cashCents: 700, giftCents: 500 });
    ...
    assert.deepStrictEqual([wallet.cashCents, wallet.giftCents, wallet.vipSpendCents], [300, 0, 1325]);
    ...
    console.log("Wallet checks passed: recharge VIP, gift-first holds, settlement, expiry release, and idempotency.");
  } finally {
